...
class Modal {
    ...
    filterIntroText(lines) {
        const introPatterns = [
            ...
            /ниже.*швидкий.*конкретний аналіз/i,
            /нижче.*швидкий.*конкретний аналіз/i,
            /ниже.*швидкий.*конкретный анализ/i,
            /нижче.*швидкий.*конкретный анализ/i,
            /ниже.*быстрый.*конкретный анализ/i,
            /нижче.*быстрый.*конкретный анализ/i,
            /ниже.*quick.*specific analysis/i,
            /нижче.*quick.*specific analysis/i,
            /ниже.*на основі наданого тексту/i,
            /нижче.*на основі наданого тексту/i,
            /ниже.*на основе предоставленного/i,
            /нижче.*на основе предоставленного/i,
            /ниже.*на основе предоставленного текста/i,
            /нижче.*на основе предоставленного текста/i,
            /ниже.*based on the provided/i,
            /нижче.*based on the provided/i,
