...
class DataDisplay {
    ...
    getPlatformIcon(platform) {
        const platformIcons = {
            ...
            'audience_network': '<svg width="16" height="16" viewBox="0 0 24 24"><rect width="24" height="24" rx="4" fill="#6B46C1"/><path d="M12 8c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4zm0 6c-1.1 0-2-0.9-2-2s0.9-2 2-2 2 0.9 2 2-0.9 2-2 2z" fill="white"/><path d="M15 13l2 2-1.4 1.4-2-2z" fill="white"/></svg>',
        ...
        return platformIcons[normalizedPlatform] || String(platform).toLowerCase();
    }
