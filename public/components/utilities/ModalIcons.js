...
class ModalIcons {
    static get(fieldKey) {
        const icons = {
            ...
            'funnel_stage': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3 2v2l8 8v10l2-2V12l8-8V2H3z"/></svg>',

            'funnel_reasoning': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>',
            ...
            'originality': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M9 11.24V7.5C9 6.12 10.12 5 11.5 5S14 6.12 14 7.5v3.74c1.21-.81 2-2.18 2-3.74C16 5.01 13.99 3 11.5 3S7 5.01 7 7.5c0 1.56.79 2.93 2 3.74zm9.84 4.63l-4.54-2.26c-.17-.07-.35-.11-.54-.11H13v-6c0-.83-.67-1.5-1.5-1.5S10 6.67 10 7.5v10.74l-3.43-.72c-.08-.01-.15-.03-.24-.03-.31 0-.59.13-.79.33l-.79.8 4.94 4.94c.27.27.65.44 1.06.44h6.79c.75 0 1.33-.55 1.44-1.28l.75-5.27c.01-.07.02-.14.02-.2 0-.62-.38-1.16-.91-1.38z"/></svg>',
            ...
            'mini_swot': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14H5v-5h5v5zm0-7H5V5h5v5zm7 7h-5v-5h5v5zm0-7h-5V5h5v5z"/></svg>',

            'placement_fit': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',
            ...
            'hook_phrase': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6c0-3.31 2.69-6 6-6s6 2.69 6 6-2.69 6-6 6-6-2.69-6-6zm12 10v-2c0-1.11-.89-2-2-2h-8c-1.11 0-2 .89-2 2v2h-2v2h16v-2h-2zM4 4h6v2H4V4zm0 4h6v2H4V8zm0 4h6v2H4v-2z"/></svg>',

            'storytelling': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zM5 10h5v3H5zm7 0h7v3h-7zm0-4h7v3h-7zm-7 0h5v3H5z"/></svg>',
            ...
            'drivers': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/></svg>',

            'techniques': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z"/></svg>',
            ...
            'cta': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>',
            ...
            'novelty': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M9 11.24V7.5C9 6.12 10.12 5 11.5 5S14 6.12 14 7.5v3.74c1.21-.81 2-2.18 2-3.74C16 5.01 13.99 3 11.5 3S7 5.01 7 7.5c0 1.56.79 2.93 2 3.74zm9.84 4.63l-4.54-2.26c-.17-.07-.35-.11-.54-.11H13v-6c0-.83-.67-1.5-1.5-1.5S10 6.67 10 7.5v10.74l-3.43-.72c-.08-.01-.15-.03-.24-.03-.31 0-.59.13-.79.33l-.79.8 4.94 4.94c.27.27.65.44 1.06.44h6.79c.75 0 1.33-.55 1.44-1.28l.75-5.27c.01-.07.02-.14.02-.2 0-.62-.38-1.16-.91-1.38z"/></svg>',

            // ========================================
            // TECHNICAL ICONS (Video)
            // ========================================
            ...
            // VISUAL ICONS (Video)
            // ========================================
            'hook_first_seconds': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/></svg>',
            ...
            'overall_style': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg>',

            // ========================================
            // PEOPLE ICONS (Video)
            // ========================================
            'people_description': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>',
            ...
            'product_presentation': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/></svg>',

            'branding_visibility': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>',
            2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>',

                        // ========================================
                        // SUMMARY ICONS (Video)
                        // ========================================
                        'what_advertised': '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>',
                    ...
                    // Return icon or default fallback icon
                    return icons[fieldKey] || this.getDefaultIcon();
                }

                /**
                 * Get default fallback icon
                 * @returns {string} Default icon SVG
                 */
                static getDefaultIcon() {
                    return '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/></svg>';
                }

                /**
                 * Check if icon exists for field
                 * @param {string} fieldKey - The field key
                 * @returns {boolean} True if icon exists
                 */
                static has(fieldKey) {
                    return this.get(fieldKey) !== this.getDefaultIcon();
                }

                /**
                 * Get all available icon keys
                 * @returns {Array<string>} Array of icon keys
                 */
                static getAllKeys() {
                    return [
                        // Copywriting
                        'offer_clarity', 'specificity', 'language_simplicity', 'tone_of_voice',
                        'structure', 'offer_usp_separation',

                        // Marketing
                        'offer_type', 'funnel_stage', 'funnel_reasoning', 'consistency',
                        'originality', 'seasonality', 'mini_swot', 'placement_fit',

                        // Psychology
                        'main_drivers', 'structure_used', 'hook_phrase', 'storytelling',
                        'influence_techniques', 'tonality', 'drivers', 'techniques',

                        // Sales
                        'value_proposition', 'cta_strength', 'risk_reversal', 'price_psychology',
                        'cta', 'price_signals',

                        // Metrics
                        'rotation_insight', 'novelty',

                        // Technical (Video)
                        'format', 'quality', 'subtitles',

                        // Visual (Video)
                        'hook_first_seconds', 'tempo', 'scene_variety', 'overall_style',

                        // People (Video)
                        'people_description', 'influencers', 'product_presentation', 'branding_visibility',

                        // Summary (Video)
                        'what_advertised', 'creative_quality', 'strengths', 'weaknesses'
                    ];
                }

                /**
                 * Get icon by category
                 * @param {string} category - Category name (copywriting, marketing, etc.)
                 * @returns {Object} Object with field keys and icons
                 */
                static getByCategory(category) {
                    const categories = {
                        copywriting: [
                            'offer_clarity', 'specificity', 'language_simplicity',
                            'tone_of_voice', 'structure', 'offer_usp_separation'
                        ],
                        marketing: [
                            'offer_type', 'funnel_stage', 'funnel_reasoning',
                            'consistency', 'originality', 'seasonality', 'mini_swot', 'placement_fit'
                        ],
                        psychology: [
                            'main_drivers', 'structure_used', 'hook_phrase',
                            'storytelling', 'influence_techniques', 'tonality', 'drivers', 'techniques'
                        ],
                        sales: [
                            'value_proposition', 'cta_strength', 'risk_reversal',
                            'price_psychology', 'cta', 'price_signals'
                        ],
                        metrics: ['rotation_insight', 'novelty'],
                        technical: ['format', 'quality', 'subtitles'],
                        visual: ['hook_first_seconds', 'tempo', 'scene_variety', 'overall_style'],
                        people: ['people_description', 'influencers', 'product_presentation', 'branding_visibility'],
                        summary: ['what_advertised', 'creative_quality', 'strengths', 'weaknesses']
                    };
